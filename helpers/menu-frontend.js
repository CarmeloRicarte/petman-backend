  ...
  const menu = [
    {
      ...
      submenu: [
        { titulo: "Dashboard", url: "dashboard", icono: "pi pi-info-circle" },
        {
          ...
          submenu: [
            { titulo: "Crear Venta", url: "tpv/crear", icono: "pi pi-ticket" },
            {
              titulo: "Listado de Ventas",
              url: "tpv/listado-ventas",
              icono: "pi pi-list",
            },
          ],
        },
    ...
    },
    {
      ...
      submenu: [
        {
          titulo: "Envíos de mercancía",
          url: "envio-mercancia",
          icono: "pi pi-send",
        },
        {
          titulo: "Recepciones de mercancía",
          url: "recepcion-mercancia",
