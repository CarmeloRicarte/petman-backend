...
const getReviews = async (url, output = "json") => {
    ...
    await page.waitForSelector('.mapsConsumerUiSubviewSectionReview__section-review-content');
    ...
    const data = await page.evaluate(() => {
        ...
        for (let elements of ratingsClasses) {
            ...
            for (const star of elements.children) {
                if (star.className.indexOf("section-review-star-active") !== -1) {
                    ratingStars++;
                }
        ...
        let reviews = [];
        // console.log(reviewAuthorNames, dates, ratings, reviewsContent);
        for (let i = 0; i < 3; i++) {
            reviews.push({
